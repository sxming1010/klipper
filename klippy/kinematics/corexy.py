...
class CoreXYKinematics:
    def __init__(self, toolhead, config):
        ...
        self.rails[3].setup_itersolve('cartesian_stepper_alloc', b'a')  # 设置 'a' 轴
        self.rails[4].setup_itersolve('cartesian_stepper_alloc', b'b')  # 设置 'b' 轴
    ...
    def calc_position(self, stepper_positions):
        ...
        return [0.5 * (pos[0] + pos[1]), 0.5 * (pos[0] - pos[1]), pos[2], pos[3], pos[4]]  # 添加 'a' 和 'b' 轴
